...
![Alt text](file:6a62030a-f005-4568-abba-1d65388edadd)
...
![Alt text](file:b0687498-03d2-453e-9030-e1a34faf91c8)
...
## 26. Using MCP Servers with OpenRouter
...
<Note title="Supported models">
  ...
  <ul>
    ...
    <li>
      Anthropic models (by using the <code>reasoning.max\_tokens</code>{' '}
      parameter)
    </li>
  </ul>
</Note>
...
**Source:** https://openrouter.ai/docs/community/frameworks.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/completion.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/chat-completion.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/get-a-generation.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/list-available-models.mdx
...
## 35. List endpoints for a model

**Source:** https://openrouter.ai/docs/api-reference/list-endpoints-for-a-model.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/get-credits.mdx
...
## 37. Create a Coinbase charge

**Source:** https://openrouter.ai/docs/api-reference/create-a-coinbase-charge.mdx
...
## 38. Exchange authorization code for API key

**Source:** https://openrouter.ai/docs/api-reference/authentication/exchange-authorization-code-for-api-key.mdx
...
## 39. Get current API key

**Source:** https://openrouter.ai/docs/api-reference/api-keys/get-current-api-key.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/api-keys/list-api-keys.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/api-keys/create-api-key.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/api-keys/get-api-key.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/api-keys/delete-api-key.mdx
...
**Source:** https://openrouter.ai/docs/api-reference/api-keys/update-api-key.mdx
